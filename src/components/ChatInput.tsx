    ...
    <div className="p-4 border-t border-gray-200 bg-white">
      ...
      <div className="flex items-end gap-2 mt-2">
        ...
        <button
          ...
          className={`p-2 text-gray-500 hover:text-blue-600 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-300 disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0 ${attachedFile ? 'opacity-50 cursor-not-allowed' : ''}`}
        ...
        <textarea
          ...
          className="flex-grow p-2 border border-gray-300 rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-blue-300 max-h-40 overflow-y-auto text-sm text-gray-800"
        ...
        <button
          ...
          disabled={!canSend}
          className="p-2 bg-blue-500 text-white rounded-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300 disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
